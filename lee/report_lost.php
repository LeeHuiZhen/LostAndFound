    ...
    <div class="app-container" style="max-width: 660px;">
        <div class="glass-card">
            ...
            <form action="save_report.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    <label for="location" class="fw-bold">Location Lost *</label>
                ...
                <div class="form-group mb-4">
                    <label for="date" class="fw-bold">Date Lost *</label>
                ...
                <div class="d-flex gap-3">
                    ...
                    <button type="submit" class="btn-custom btn-custom-primary flex-fill py-2"><?php echo $edit_mode ? 'Update Report →' : 'Submit Report →'; ?></button>
                </div>
            </form>
        </div>
