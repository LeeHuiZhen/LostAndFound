...
<head>
    ...
    <title>Report Lost Item - Lost & Found Assistant</title>
    <!-- Bootstrap 5 -->
    ...
    <div class="app-container" style="max-width: 650px;">
        <div class="glass-card">
            <div class="text-center mb-4">
                ...
                <h2 class="mt-2" style="border-bottom: none; padding-bottom: 0;">Report Lost Item</h2>
                <p class="text-muted" style="font-size: 13px;">Enter details of the item you have lost on campus</p>
            </div>

            <form action="save_report.php" method="POST" enctype="multipart/form-data">
                <!-- Hidden type set to lost -->
                <input type="hidden" name="type" value="lost">

                <div class="form-group">
                    <label for="item_name">Item Name *</label>
                    <input type="text" name="item_name" id="item_name" class="form-control" placeholder="e.g., UTM Matric Card, Sony Headphones" required>
                </div>

                <div class="form-group">
                    <label for="description">Detailed Description *</label>
                    <textarea name="description" id="description" class="form-control" rows="4" placeholder="Describe the color, brand, unique stickers, keychains, or key details that identify the item..." required></textarea>
                </div>

                <div class="form-group">
                    <label for="location">Location Lost *</label>
                    <input type="text" name="location" id="location" class="form-control" placeholder="e.g., UTM Library, FC Block N28 room 302" required>
                ...
                <div class="form-group mb-4">
                    ...
                    <small class="text-muted" style="font-size: 11px;">Provide a clear photo of the item or a similar reference image (Max: 5MB).</small>
                </div>

                <div class="d-flex gap-3">
                    <a href="../syafiqah/matching/dashboard.php" class="btn-custom btn-custom-secondary flex-1">Cancel</a>
                    <button type="submit" class="btn-custom btn-custom-primary flex-1">Submit Report</button>
                </div>
            </form>
        </div>
    </div>
