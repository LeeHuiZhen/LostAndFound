...
<head>
    ...
    <style>
        ...
        .leaflet-container { background: var(--bg-surface); }
    </style>
</head>
<body>
    ...
    <div class="header-hero" style="padding:50px 20px;">
        <h1 style="font-size:32px; margin-bottom:8px;">📝 Report a Lost Item</h1>
        <p>Help us help you — the more detail you provide, the better our matching engine performs.</p>
    </div>
            ...
            <form action="save_report.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="item_name" id="item_name" class="form-control"
                           placeholder="e.g., UTM Matric Card, Sony WH-1000XM5 Headphones" required>
                </div>

                <div class="form-group">
                    <label for="description">Detailed Description *</label>
                    <textarea name="description" id="description" class="form-control" rows="4"
                              placeholder="Describe unique features: colour, brand, stickers, keychains, engravings, purchase date, or any identifiers..." required></textarea>
                </div>

                <div class="form-group">
                    <label for="location">Location Lost *</label>
                    <input type="text" name="location" id="location" class="form-control"
                           placeholder="e.g., UTM Library Level 2, Block N28 Room 302" required>
                    <div id="map"></div>
                    <small style="font-size:11px; color:var(--text-muted); margin-top:6px; display:block;">
                        💡 Click or drag the marker on the map to auto-populate the location field.
                    </small>
                </div>
                ...
                <div style="display:flex; gap:12px; margin-top:8px;">
                    ...
                    <button type="submit" class="btn-custom btn-custom-primary flex-fill">🔴 Submit Lost Report</button>
                </div>
            </form>
        </div>
    </div>
