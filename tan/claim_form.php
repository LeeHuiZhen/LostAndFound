...
<head>
    ...
    <title>Claim Item - Lost and Found Assistant</title>
    <style>
        ...
        .btn-back { display: inline-block; background: #6c757d; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; }
